...
from src.common.constant import SRC_DIRECTORY, BASKETLAB_WITH_SPOTRAC_FILE
...
def generate_full(min_year: str, max_year: str, environment: Environment) -> None:
    list_scripts = [['bbref', 'top100.py'], ['538', 'top100.py'], ['bbindex', 'top100.py'], ['spotrac', 'top100.py']]
