...
from top100_utils import generate_full

USAGE_EXAMPLE = "Example: ./run.sh top100 2023 [2024] [local|prod]"
...
generate_full(argv_min_year, argv_max_year, argv_environment)
