...
from src.sportpress.team_games_processor import generate_games

USAGE_EXAMPLE = "Example: ./run.sh sportpress_team_games sas 2024 [local|prod]"
...
generate_games(argv_team.lower(), argv_year, argv_environment)
